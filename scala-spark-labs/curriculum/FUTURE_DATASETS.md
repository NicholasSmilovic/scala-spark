...
This dataset is assigned to Curriculum 09, whose goals genuinely require realistic scale for large CSV ingestion, partition strategy, executor evidence, skew, and class-imbalance observation. Prefer small controlled fixtures for correctness lessons in Curricula 06–08.
...
Spark does not read the CSV member inside a ZIP archive as an ordinary CSV source. When Curriculum 09 is activated:
