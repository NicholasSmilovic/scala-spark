...
When a curriculum is complete, compress its progress file to the evidence needed for future teaching, mark the next curriculum active in `learning/ACTIVE.md`, and leave prior source/data untouched.
